...
echo "2. Push your code to GitHub (the workflow will auto-deploy)"
echo "3. Or manually deploy using: gh-pages -d build/web"
echo ""
echo "🌐 Your site will be available at:"
echo "   https://hossameldinmi.github.io/website/"
